...
- **Next: Step 3** — repoint the app's data source (`api/_lib/data.js` + `api/dse/[code].js` mapping) to the contract behind flag `elevate_contract_v3`; AAA634 Earnings should then read **₹5,356.34** (adapter only, no redesign).
