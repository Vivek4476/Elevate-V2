...
- **Next: Step 8 — Admin** (rebuild Manager console into template→upload→pandera validate→reconcile-before-publish→versioned publish→audit→rollback; strip JSON-FALLBACK/Pre-fill strings). Build-Plan-v2 Phase 4.
